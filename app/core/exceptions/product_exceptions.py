...
class ProductNotDeletedException(AppException):
    ...
    def __init__(self):
        super().__init__(message="El producto no estaba eliminado.", code=400)
...
class ProductAlreadyDeletedException(AppException):
    ...
    def __init__(self):
        super().__init__(message="El producto ya estaba eliminado.", code=400)
...
class ProductAlreadyActiveException(AppException):
    ...
    def __init__(self):
        super().__init__(message="El producto ya estaba disponible.", code=400)
...
class ProductAlreadyInactiveException(AppException):
    ...
    def __init__(self):
        super().__init__(message="El producto ya estaba no disponible.", code=400)
...
class InvalidProductPriceException(AppException):
    ...
    def __init__(self):
        super().__init__(message="El precio del producto debe ser mayor a 0.", code=400)
